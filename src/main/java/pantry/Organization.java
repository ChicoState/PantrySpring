...
public class Organization implements Provider {
  private UUID _uuid;
  ...
  // Constructor
  // create an Organization provider with random UUID and given name
  Organization(String name) {
    _uuid = UUID.randomUUID();
    _name = name;
  }

  // Return the UUID and name of this Organization
